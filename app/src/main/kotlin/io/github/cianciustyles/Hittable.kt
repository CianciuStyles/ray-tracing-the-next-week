...
abstract class Hittable {
    ...
    fun hitRecord(ray: Ray, outwardNormal: Vector3, material: Material, t: Double, u: Double, v: Double): HitRecord {
        val frontFace = ray.direction dot outwardNormal < 0
        val normal = if (frontFace) outwardNormal else -outwardNormal

        return HitRecord(ray.at(t), normal, material, t, u, v, frontFace)
    }
}